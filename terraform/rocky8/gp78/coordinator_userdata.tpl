  ...
  - |
    ...
    EOF
        ...
        su - gpadmin <<EOF
          set -x
          source /usr/local/greenplum-db/greenplum_path.sh
          $GPPKG_INSTALL_CMD /home/gpadmin/plr*gp7-rhel8-x86_64.gppkg
          gpssh -f hosts-all "echo 'export LD_LIBRARY_PATH=\""'$'"GPHOME/ext/R-3.3.3/lib:"'$'"LD_LIBRARY_PATH\"' >> /usr/local/greenplum-db/greenplum_path.sh"
          gpstop -M fast -ra
    EOF
    fi