...
runcmd:
  - |
    ...
    # Notify completed. This has to stay the last step, the coordinator starts gpinitsystem
    # and gpccinstall as soon as every segment has reported in, and gpccinstall can only
    # unpack the ccagent into /usr/local/greenplum-cc once the directory exists here
    su - gpadmin <<EOF
      touch `hostname`
