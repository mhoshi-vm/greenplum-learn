...
runcmd:
  - |
    ...
    su - gpadmin <<EOF
      set -x
      source /usr/local/greenplum-db/greenplum_path.sh
      gpconfig -c pgml.venv -v '/usr/local/greenplum-db/ext/DataSciencePython3.11/'
      gpconfig -c plpython3.python_path -v "'$GPHOME/ext/DataSciencePython3.11/lib/python3.11/site-packages:$GPHOME/ext/DataSciencePython3.11/lib64/python3.11/site-packages'" --skipvalidation
      gpstop -u
    EOF
